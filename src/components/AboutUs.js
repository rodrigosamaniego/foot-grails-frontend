...
export default function AboutUs() {
  ...
  <div class="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mx-auto text-base max-w-prose lg:grid lg:grid-cols-2 lg:gap-8 lg:max-w-none">
      <div>
        <h2 class="text-base text-black-600 font-semibold tracking-wide ">Foot Grails</h2>
        <h3 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Statement Piece</h3>
      </div>
    </div>
    <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
        ...
        <div class="relative text-base mx-auto max-w-prose lg:max-w-none">
          <figure>
            <div class="aspect-w-12 aspect-h-7 lg:aspect-none">
              <img class="rounded-lg shadow-lg object-cover object-center" src="https://i.pinimg.com/564x/8a/56/c8/8a56c89cc8c0b65abefb1ce7fa8631e5.jpg" width="1184" height="1376"/>
            </div>
      ...
      <div class="mt-8 lg:mt-0">
        ...
        <div class="mt-5 prose prose-indigo text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
          <p class="mt-6 text-lg text-gray-500">Rodrigo Samaniego Pizá. Mexico City, 2021  </p>
        </div>
